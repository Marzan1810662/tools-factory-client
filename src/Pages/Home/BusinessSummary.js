...
const BusinessSummary = () => {
    return (
        <div className='py-2 my-2 bg-gradient-to-r from-[#a7665afa] to-[#f0d4c5]'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-4 lg:gap-10 px-4 lg:px-28 my-6'>
                <div data-aos="fade-up" className='h-60 bg-base-100 bg-opacity-60 rounded shadow-lg text-[#421700] p-3'>
                    <FontAwesomeIcon className='w-20 h-20 mt-9' icon={faFlag}/>
                    <p className='text-3xl font-bold'>20+ Countries</p>
                </div>
                <div data-aos="fade-up" className='w-full h-60 bg-base-100 bg-opacity-60 rounded shadow-lg text-[#421700] p-3'>
